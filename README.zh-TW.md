...
| <img src=".github/assets/tools-icon/volcengine.png" width="28" alt="Volcengine" /> | Volcengine | 火山引擎 AK/SK（透過火山引擎 OpenAPI 查詢火山方舟 Agent Plan / Coding Plan 額度） | — | ✅ | — |
...
- **視窗行為**——選擇置頂、普通，或懸浮（失焦即收進通知區）；三種模式皆可拖曳、縮放，且不顯示於工作列。
