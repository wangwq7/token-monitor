...
| <img src=".github/assets/tools-icon/volcengine.png" width="28" alt="Volcengine" /> | Volcengine | Volcengine AK/SK（Volcengine OpenAPI で Ark Agent Plan / Coding Plan クォータ取得） | — | ✅ | — |
...
- **ウィンドウ動作** — 最前面、通常、トレイへ（フォーカスを失うと通知領域に隠れる）。いずれもドラッグ・リサイズ可能でタスクバーに表示されません。
